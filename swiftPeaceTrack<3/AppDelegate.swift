...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func saveContext () {
        ...
        if let moc = managedObjectContext as NSManagedObjectContext! {
    ...
    var managedObjectContext: NSManagedObjectContext {
        if !(_managedObjectContext != nil) {
            ...
            if let co = coordinator as NSPersistentStoreCoordinator! {
                _managedObjectContext = NSManagedObjectContext()
                _managedObjectContext!.persistentStoreCoordinator = co
            }
        }
